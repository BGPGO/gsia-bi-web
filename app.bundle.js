  ...
  const recrutadorData = useMemo(() => {
    ...
    for (const v of filteredVagas) {
      ...
      if (!r)
        continue;
      if (!map[r])
        map[r] = { fechadas: 0, abertas: 0, canceladas: 0, diasTotal: 0, diasCount: 0 };
      if (v.status === "FECHADO") {
        map[r].fechadas++;
        if (v.diasFechamento != null) {
          map[r].diasTotal += v.diasFechamento;
...
const AlertaVagasPopup = () => {
  ...
  const diasAberta = (d) => {
    if (!d)
      return "?";
    return Math.max(0, Math.round((/* @__PURE__ */ new Date() - new Date(d)) / 864e5));
  };
  const lista = tab === "novas" ? novasAbertas : abertas;
  return /* @__PURE__ */ React.createElement("div", { className: "popup-overlay", onClick: () => setVisible(false) }, /* @__PURE__ */ React.createElement("div", { className: "popup-card", onClick: (e) => e.stopPropagation() }, /* @__PURE__ */ React.createElement("div", { className: "popup-header" }, /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10 } }, /* @__PURE__ */ React.createElement("div", { className: "popup-icon-pulse" }, /* @__PURE__ */ React.createElement(Icon, { name: "alert", style: { width: 22, height: 22, color: "#fff" } })), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("div", { className: "popup-title" }, abertas.length, " vaga", abertas.length > 1 ? "s" : "", " em aberto"), /* @__PURE__ */ React.createElement("div", { className: "popup-subtitle" }, novasAbertas.length > 0 ? `${novasAbertas.length} nova${novasAbertas.length > 1 ? "s" : ""} detectada${novasAbertas.length > 1 ? "s" : ""} na última atualização` : "Nenhuma vaga nova na última atualização"))), /* @__PURE__ */ React.createElement("button", { className: "popup-close", onClick: () => setVisible(false) }, "×")), /* @__PURE__ */ React.createElement("div", { style: { display: "flex", gap: 0, borderBottom: "1px solid var(--border)", padding: "0 20px" } }, /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      style: {
        ...
        background: "none",
        border: "none",
        color: tab === "abertas" ? "var(--cyan)" : "var(--mute)",
    ...
    abertas.length,
    ")"
  ), novasAbertas.length > 0 && /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      style: {
        ...
        background: "none",
        border: "none",
        color: tab === "novas" ? "#f59e0b" : "var(--mute)",
    ...
    novasAbertas.length,
    ")"
  )), /* @__PURE__ */ React.createElement("div", { className: "popup-body" }, lista.length === 0 && /* @__PURE__ */ React.createElement("div", { style: { color: "var(--mute)", padding: 20, textAlign: "center" } }, "Nenhuma vaga nova nesta atualização"), lista.map((v, i) => /* @__PURE__ */ React.createElement("div", { key: i, className: `popup-vaga-item${isNova(v) ? " popup-vaga-nova" : ""}` }, /* @__PURE__ */ React.createElement("div", { className: "popup-vaga-row" }, /* @__PURE__ */ React.createElement("span", { className: "popup-vaga-cliente" }, isNova(v) && /* @__PURE__ */ React.createElement("span", { style: { background: "#f59e0b", color: "#000", fontSize: 9, fontWeight: 700, padding: "1px 6px", borderRadius: 4, marginRight: 6, textTransform: "uppercase", letterSpacing: "0.05em" } }, "Nova"), v.cliente), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, fontWeight: 700, color: diasAberta(v.dataAbertura) > 5 ? "var(--red)" : "var(--amber)" } }, diasAberta(v.dataAbertura), "d aberta")), /* @__PURE__ */ React.createElement("div", { className: "popup-vaga-details" }, /* @__PURE__ */ React.createElement("span", null, v.cargo), /* @__PURE__ */ React.createElement("span", { style: { color: "var(--mute)" } }, "·"), /* @__PURE__ */ React.createElement("span", null, v.responsavel), v.qtdVagas > 1 && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--mute)" } }, "·"), /* @__PURE__ */ React.createElement("span", null, v.qtdVagas, " vagas"))), /* @__PURE__ */ React.createElement("div", { className: "popup-vaga-meta" }, /* @__PURE__ */ React.createElement("span", null, "Abertura: ", fmtDate(v.dataAbertura)), v.motivo && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("span", { style: { color: "var(--mute)" } }, "·"), /* @__PURE__ */ React.createElement("span", null, v.motivo))))))));
};
const App = () => {
  const [page, setPage] = useState("vagas");
  return /* @__PURE__ */ React.createElement("div", { className: "app" }, /* @__PURE__ */ React.createElement(Sidebar, { active: page, onSelect: setPage }), /* @__PURE__ */ React.createElement("div", { className: "main" }, /* @__PURE__ */ React.createElement(Header, { page }), page === "vagas" && /* @__PURE__ */ React.createElement(PageVagas, null), page === "executivo" && /* @__PURE__ */ React.createElement(PageExecutivo, null)), /* @__PURE__ */ React.createElement(AlertaVagasPopup, null));
};
